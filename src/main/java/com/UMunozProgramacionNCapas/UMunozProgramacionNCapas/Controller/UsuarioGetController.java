...
public class UsuarioGetController {
    ...
    public String searchUsuarios(Model model,
        ...
        try {
            ...
            if (apellidoPaterno != null && !apellidoPaterno.isBlank()) builder.queryParam("apellidoPaterno", apellidoPaterno);
            if (apellidoMaterno != null && !apellidoMaterno.isBlank()) builder.queryParam("apellidoMaterno", apellidoMaterno);
    ...
    // Eliminar una dirección asociada a un usuario (usa el DELETE del API de direcciones)
    @GetMapping("/direccion/delete")
    public String deleteDireccion(@RequestParam("IdUsuario") int IdUsuario,
        ...
        try {
            String url = urlBase + "api/direccion/delete/direccion?IdDireccion=" + IdDireccion;
